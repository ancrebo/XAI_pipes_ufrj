...
"""
-------------------------------------------------------------------------------------------------------------------------
shap_intensity_structure.py
-------------------------------------------------------------------------------------------------------------------------
Created on Wed Apr  3 15:02:00 2024

@author: Andres Cremades Botella

File to define the SHAP structures using the absolute value of the intensity of the shap values:
    Class:
...
class shap_structure():
    ...
    def calculate_matstruc(self):
        ...
        shap_xyz         = np.sqrt(field_u**2+field_w**2+field_v**2)
        shap_rms         = np.sqrt(data_SHAPrms["SHAP_urms"]**2+data_SHAPrms["SHAP_wrms"]**2+
                                   data_SHAPrms["SHAP_vrms"]**2).reshape(-1,1,1)
    ...
    def segment_struc(self):
        ...
        # ---------------------------------------------------------------------------------------------------------------
        data_struc      = {"mat_struc":self.mat_struc,"field_1":self.vel_u,"field_2":self.vel_v,
