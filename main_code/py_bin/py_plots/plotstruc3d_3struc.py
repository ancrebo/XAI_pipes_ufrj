...
def plotstruc3d_3struc(data_in={"struc1":[],"struc2":[],"struc3":[],"plot_folder":"plots","xlabel":"$x^+$",
                                "ylabel":"$y^+$","zlabel":"z^+","fontsize":18,"figsize_x":10,"figsize_y":8,
                                "colormap1":"viridis","colormap2":"viridis","colormap3":"viridis","colornum":2,
                                ...
                                "rey":125,"utau":0.060523258443963,"cmap_flag":False}):
    """
    .....................................................................................................................
    # plotstruc3d_3struc: Function to generate the plot of the 3d structures of 2 types
    .....................................................................................................................
    Parameters
    ----------
    data_in : dict, optional
        Data required for generating the plot. 
        The default is {"struc1":[],"struc2":[],"struc3":[],"plot_folder":"plots","xlabel":"$x^+$",
                        "ylabel":"$y^+$","zlabel":"z^+","fontsize":18,"figsize_x":10,
                        "figsize_y":8,"colormap1":"viridis","colormap2":"viridis","colormap3":"viridis","colornum":2,
        ...
        Data:
            ...
            - struc3      : data of the structures of type 3
            ...
            - colormap3   : colormap used for the figure
    ...
    mat_segment3 = struc3.structures.mat_segment_filtered
    ...
    plot_info3 = {"data_x":flow_data.xplus,"data_y":flow_data.y_h*rey,"data_z":flow_data.zplus,"struc":mat_segment3,
                  "color":colormap3,"cmap_flag":cmapflag,"vmax":rey,"vmin":-3*rey}
...
def plotstruc3d_3struc_separate(data_in={"struc1":[],"struc2":[],"struc3":[],"plot_folder":"plots","xlabel":"$x^+$",
                                         "ylabel":"$y^+$","zlabel":"z^+","fontsize":18,"figsize_x":10,
                                         "figsize_y":8,"colormap1":"viridis","colormap2":"viridis",
                                         "colormap3":"viridis","colornum":2,"fig_name":"struc3d","dpi":60,
    ...
    mat_segment3     = struc3.structures.mat_segment_filtered
    mat_segment3_low = mat_segment3[:flow_data.yl_s,:,:]
    mat_segment3_upp = np.flip(mat_segment3[flow_data.yu_s:,:,:],0)
    index            = str(struc1.index)
    ...
    plot_info2 = {"data_x":flow_data.xplus,"data_y":flow_data.yplus,"data_z":flow_data.zplus,"struc":mat_segment2_low,
                  "color":colormap2,"cmap_flag":cmapflag,"vmax":rey,"vmin":-3*rey}
    plot_info3 = {"data_x":flow_data.xplus,"data_y":flow_data.yplus,"data_z":flow_data.zplus,"struc":mat_segment3_low,
                  "color":colormap3,"cmap_flag":cmapflag,"vmax":rey,"vmin":-3*rey}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_train.add_plot_3d_structure(data_in=plot_info2)
    plot_train.add_plot_3d_structure(data_in=plot_info3)
    ...
    plot_info2 = {"data_x":flow_data.xplus,"data_y":flow_data.yplus,"data_z":flow_data.zplus,"struc":mat_segment2_upp,
                  "color":colormap2,"cmap_flag":cmapflag,"vmax":rey,"vmin":-3*rey}
    plot_info3 = {"data_x":flow_data.xplus,"data_y":flow_data.yplus,"data_z":flow_data.zplus,"struc":mat_segment3_upp,
                  "color":colormap3,"cmap_flag":cmapflag,"vmax":rey,"vmin":-3*rey}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_train.add_plot_3d_structure(data_in=plot_info2)
    plot_train.add_plot_3d_structure(data_in=plot_info3)
